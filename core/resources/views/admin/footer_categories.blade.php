            ...
            <div class="card-body text-center">
                ...
                <form method="post" action="{{route('admin.settings.footer_categories.submit')}}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <input type="text" name="categories_id[]" value="{{$footerCategories[$i]->id}}" class="form-control" placeholder="Insert News Id">
                        </div>
                        <div class="col-sm-3">
                            <input type="text" class="form-control" value="{{$footerCategories[$i]->name}}">
                        </div>
                        <div class="col-sm-3">
                            <input type="text" class="form-control" value="{{$footerCategories[$i]->name_parent}}">
                        </div>
                    </div>
                    <br>
                    @endfor
