            ...
            <div class="card-body text-center">
                ...
                <form method="post" action="{{route('admin.settings_footer_categories_submit')}}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <input type="text" name="categories_id[]" value="{{$footerCategories[$i]->id}}" class="form-control form-control-lg" placeholder="Insert News Id">
                        </div>
                        <div class="col-sm-3">
                            <input type="text" class="form-control form-control-lg" value="{{$footerCategories[$i]->name}}">
                        </div>
                        <div class="col-sm-3">
                            <input type="text" class="form-control form-control-lg" value="{{$footerCategories[$i]->name_parent}}">
                        </div>
                    </div>
                    <br>
                    @endfor
        ...
        $(document).ready(function(){
            $("#addPreference").click(function(){
                $("#appendingPoint").append(
                    ...
                    "   </div>\n" +
                    "   <div class=\"col-sm-3\">\n" +
                    "       <input type=\"text\" class=\"form-control form-control-lg is-valid\" placeholder=\"Please Leave this Empty\">\n" +
                    "   </div>\n" +
                    "   <div class=\"col-sm-3\">\n" +
                    "       <input type=\"text\" class=\"form-control form-control-lg is-valid\" placeholder=\"Please Leave this Empty\">\n" +
                    "   </div>\n" +
