...
<div class="content p-4">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form method="POST" action = "{{ route('admin.created.image.submit') }}" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Image Title:</label>
                    <div class="col-sm-10">
                        <input type="text" name="title" class="form-control" placeholder="Title of Image" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Image Description:</label>
                    <div class="col-sm-10">
                        <textarea id="textArea" name="description" class="form-control" placeholder="Description of Image" rows="5" required> </textarea>
                    </div>
                </div>
                <div class="form-group row">
